...
// Define the same Zod schema as in the API route for client-side validation
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-2xl mx-auto">
      <div className="space-y-2">
        ...
        <input
          ...
          type="text"
          {...register('name')}
          className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-md focus:ring-2 focus:ring-cyan-500 focus:outline-none"
        />
      ...
      <div className="text-center">
        <button
          ...
          className="bg-cyan-500 text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-cyan-600 transition-all duration-300 disabled:bg-gray-600 disabled:cursor-not-allowed"
        >
      ...
      {submissionStatus && (
        <motion.div
          ...
          className={`mt-4 text-center p-3 rounded-md ${
            submissionStatus.type === 'success' ? 'bg-green-800/50 text-green-300' : 'bg-red-800/50 text-red-300'
          }`}
        >
